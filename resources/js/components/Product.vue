<template>
     <!-- product-detail -->
     <div>
     <div class="Container grid grid-row md:grid-cols-2 gap-6 mt-4" >
          
        <div >
            <img src="../../assets/product.jpg" alt="product" class="w-full">
        ...
        <div>
            <h2 class="text-3xl font-medium uppercase mb-2">{{ model.title }}</h2>
            ...
            <div class="space-y-2">
                ...
                <p class="space-x-2">
                    ...
                    <span class="text-gray-600">{{ getCategoryId(model.Category_id) }}</span>
                </p>
                <p class="space-x-2">
            ...
            <div class="flex items-baseline mb-1 space-x-2 font-roboto mt-4">
                <p class="text-xl text-primary font-semibold">${{ model.price }}</p>
            ...
            <div class="mt-4">
                ...
                <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300 w-max">
                    <div class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none" @click="decrement">-</div>
                    <div class="h-8 w-8 text-base flex items-center justify-center">{{ quantity }}</div>
                    <div class="h-8 w-8 text-xl flex items-center justify-center cursor-pointer select-none" @click="increment()">+</div>
                </div>
            </div>
